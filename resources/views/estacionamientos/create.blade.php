...
@section('content')
    <h1 class="text-center">Ingresar Nuevo Estacionamiento</h1>
    ...
    <form action="{{ route('estacionamientos.store') }}" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="number" class="form-control" name="coordenadas[lat]" id="coordenadas_lat" value="{{ old('coordenadas.lat') }}" step="any">
            </div>
        </div>
        <div class="row mb-3">
            <label for="coordenadas_lng" class="col-md-4 col-form-label text-md-end">Longitud:</label>
            <div class="col-md-6">
                <input type="number" class="form-control" name="coordenadas[lng]" id="coordenadas_lng" value="{{ old('coordenadas.lng') }}" step="any">
            </div>
        </div>
        <div class="row mb-3">
            <label for="capacidad" class="col-md-4 col-form-label text-md-end">Capacidad:</label>
            <div class="col-md-6">
                <input type="number" class="form-control" name="capacidad" id="capacidad" value="{{ old('capacidad') }}">
            </div>
        </div>
        <div class="row mb-3">
            <label for="disponibles" class="col-md-4 col-form-label text-md-end">Disponibles:</label>
            <div class="col-md-6">
                <input type="number" class="form-control" name="disponibles" id="disponibles" value="{{ old('disponibles') }}">
            </div>
        </div>
        <div class="row mb-0">
